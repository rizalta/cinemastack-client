...
const Register = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center gap-5">
      <div className={`alert alert-error mt-[80px] w-auto min-w-[407px] ${error ? "visible" : "invisible"}`}>
      ...
      <div className="card card-bordered shadow-xl px-8 py-8 bg-base-200">
        <form className="card-body" onSubmit={handleSubmit}>
          ...
          <button type="submit" className="btn btn-primary mt-10">{loading ? <span className="loading"></span> : "Register"}</button>
        </form>
      </div>
    </div> 
  )
